...
namespace DigiLearn.Web.Controllers
{
    public class TransactionController : Controller
    {
        ...
        private readonly IUserTransactionsService _transactionService;
        ...
        [Authorize]
        public async Task<IActionResult> CreateTransaction(CreateTransactions command)
        {
