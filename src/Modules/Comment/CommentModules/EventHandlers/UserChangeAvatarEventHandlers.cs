...
public class UserChangeAvatarEventHandlers : BackgroundService
{
    ...
    public UserChangeAvatarEventHandlers(IEventBus eventBus, ILogger<UserRegisterEventHandler> logger, IServiceScopeFactory serviceFactory)
    {
        _eventBus = eventBus;
        _logger = logger;
