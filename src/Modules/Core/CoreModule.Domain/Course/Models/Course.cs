...
public class Course : AggregateRoot
{
    ...
    public void AddEpisode(Guid sectionId,string title, Guid token, TimeSpan timeSpan, string videoExtension, string? attachmentExtension, bool isActive,string engilshTitle)
    {
        ...
        section.AddEpisode(title, token,timeSpan,vidName,attName,isActive,engilshTitle);
    }
